...
public class BankAccountController {
    ...
    public ArrayList<TranscationsList> getTransactions(@PathVariable long accountId, @PathVariable String from, @PathVariable String to) {

        // request url
        String url = "https://sandbox.platfr.io/api/gbs/banking/v4.0/accounts/"+accountId+"/transactions?fromAccountingDate="+from+"&toAccountingDate="+to+"/balance";
    ...
    public void moneyTransfer(HttpEntity<String> httpEntity, @PathVariable long accountId) {
        ...
        HttpEntity<String> entity = new HttpEntity<String>(json, httpEntity.getHeaders());
